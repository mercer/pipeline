...
JENKINS_HASH=$(docker run -itdP -u root -v $DATA_HOME/jenkins:/var/jenkins_home --link $SONAR_MYSQL_NAME:SONAR_MYSQL --link $SONAR_NAME:SONAR --link $ARTIFACTORY_NAME:ARTIFACTORY mercer/jenkins)
